...
OV_PATH=$SCRIPT_DIR_BUILD_GENAI/../openvino-new-arch/openvino/build
# cmake -DCMAKE_BUILD_TYPE=Debug -DENABLE_DYNAMIC_LOAD_MODEL_WEIGHTS=OFF -DENABLE_OPENVINO_NEW_ARCH=ON -DOpenVINO_DIR=$OV_PATH -S ./ -B ./build/
cmake --build ./build/ --config Debug -j 200
cmake --install ./build/ --config Debug --prefix ./install