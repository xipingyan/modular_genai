...
# pipeline_benchmark $config_yaml "prompts=Can you compare the first image and the second image? What are the main differences?" "images=./tests/test_data/qwen3_omni/case1/cars.jpg,./tests/test_data/qwen3_omni/case2/london.jpg" --warmup 0 --iter 1
...
# chat_json=./samples/cpp/benchmark/examples/qwen3_omni_chat.json
