...
if [[ "$QWEN3_OMNI" == "1" ]]; then
    ...
    cfg=./samples/config_yaml/Qwen3_omni/config_prompt_image_split_llm_sd_gpu_opt_llm.yaml
    cfg=./samples/config_yaml/Qwen3_omni/config_image_cb.yaml
    image=./tests/test_data/qwen3_omni_4b_inputs/driving_448x448.png
    image=./tests/test_data/qwen3_omni_4b_inputs/driving_512x384.png
    ...
    # cfg=./samples/config_yaml/Qwen3.5-30B/config_input_ids_cb.yaml
    # # cfg=./samples/config_yaml/Qwen3.5-30B/config_input_prompt_cb.yaml
    # "$app" "$cfg" "prompt=$prompt"
fi
